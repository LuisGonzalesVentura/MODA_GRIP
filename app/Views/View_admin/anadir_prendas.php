...
<body>
    <div class="container mx-auto mt-10">
        <!-- Título -->
        <h1 class="text-4xl font-bold text-center mb-8">AÑADIR PRODUCTOS</h1>

        <div class="flex justify-center items-center">
            <!-- Formulario a la izquierda -->
            <div class="w-1/3">
            <form action="<?= base_url('/guardar_producto') ?>" method="post" enctype="multipart/form-data" class="space-y-6">
    ...
    <div>
        ...
        <input type="file" id="productImage" name="imagen_producto" accept="image/*" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
    </div>
