...
<body>
    <div class="container mx-auto mt-10">
        <!-- Título -->
        <h1 class="text-4xl font-bold text-center mb-8">MODIFICAR PRODUCTOS</h1>
...
<div>
    ...
    <select id="producto_select" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
        ...
        <?php endforeach; ?>
            ...
            <form action="<?= base_url('/modificar_producto') ?>" method="post" enctype="multipart/form-data" class="space-y-6">
    <?= csrf_field() ?> <!-- Protección contra CSRF -->

    <!-- Campo oculto para el ID del producto -->
    <input type="hidden" id="producto_select_hidden" name="producto_select">

    <div>
        <label for="nombre_producto" class="block text-sm font-medium text-gray-700">NOMBRE DEL PRODUCTO</label>
        <input type="text" id="nombre_producto" name="nombre_producto" placeholder="Nombre del Producto" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
    </div>

    <div>
        <label for="productImage" class="block text-sm font-medium text-gray-700">Subir imagen</label>
        <input type="file" id="productImage" name="imagen_producto" accept="image/*" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
    </div>

    <div>
        <label for="precio_producto" class="block text-sm font-medium text-gray-700">PRECIO</label>
        <input type="number" id="precio_producto" name="precio_producto" placeholder="Precio 1-1000" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" step="0.01" required>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    selectProducto.addEventListener('change', function() {
        ...
        hiddenInput.value = productId; // Asignar el ID al campo oculto
