...
<head>
    ...
    <link rel="stylesheet" href="/assets/simulacion.css">
    ...
    <div class="top-div">
        ...
        <div class="scroll-left">
            <p>
                ...
                <a
                    href="https://www.instagram.com/gripclothinges/">@gripclothinges</a>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Haz
                tu
                pedido a través de nuestro instagram
                <a
                    href="https://www.instagram.com/gripclothinges/">@gripclothinges</a>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Haz
                tu
                pedido a través de nuestro instagram
                <a
                    href="https://www.instagram.com/gripclothinges/">@gripclothinges</a>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;
            </p>
            <p class="second">
                Haz tu pedido a través de nuestro instagram
                <a
...
<div class="camera-section">
    ...
    <div>
        <button type="button" class="bg-black hover:bg-gray-800 text-white font-bold py-2 px-4 rounded-md text-sm shadow-lg shadow-black" id="prenderCamara">PRENDER CAMARA</button>
    </div>
</div>
</div>
...
<div class="shirt-section">
    <!-- Aquí PHP carga dinámicamente la imagen guardada en la base de datos -->
    ...
    <!-- Botón para probar virtualmente -->
    <div>
        <button type="submit" class="bg-black hover:bg-gray-800 text-white font-bold py-2 px-4 rounded-md text-sm shadow-lg shadow-black" id="probarButton">PROBAR</button>
    </div>
</div>
</div>
...
<!-- codigo camara-->
 ...
 <!-- script para que salga la camara -->
<script>
...
// Inicialmente ocultar la cámara en vivo
cameraFeed.style.display = 'none';
noCameraFeed.style.display = 'block';

// Función para encender la cámara
prenderCamaraButton.addEventListener('click', function () {
    navigator.mediaDevices.getUserMedia({ video: true })
        .then(function (stream) {
            // Crear un objeto URL para el feed de la cámara
            cameraFeed.srcObject = stream;
            cameraFeed.style.display = 'block'; // Mostrar la cámara en vivo
            noCameraFeed.style.display = 'none'; // Ocultar imagen de cámara apagada
        })
        .catch(function (err) {
